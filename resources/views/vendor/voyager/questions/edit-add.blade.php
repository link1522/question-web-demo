                    ...
                    <form role="form" class="form-edit-add"
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group col-md-12 ">
                                <div class="flex gap-6 items-center border-0 mb-4">
                                    <label class="control-label">答案</label>
                                    <button id="addAnswerBtn" type="button" class="btn btn-success">添加答案</button>
                                </div>
                                <div>目前無答案</div>
                            </div>
                        </div><!-- panel-body -->
...
<script>
    $(() => {
        const addAnswerModal = new tingle.modal({
            footer: true,
            stickyFooter: false,
            closeMethods: ['escape']
        });

        addAnswerModal.addFooterBtn('關閉', 'btn btn-secondary', function() {
            addAnswerModal.close();
        });
        addAnswerModal.addFooterBtn('確認', 'btn btn-primary', function() {
            addAnswerModal.close();
        });

        $('#addAnswerBtn').on('click', function() {
            addAnswerModal.setContent(`
            <form class="form-group">
                <div class="mb-2">
                    <p class="control-label mb-1">答案</p>
                    <input type="text" class="form-control" />
                </div>

                <div>
                    <p class="control-label mb-1">類別</p>
                    <select class="w-full h-9 bg-white rounded border">
                        <option class="bg-blue-200">
                            1
                        </option>
                    </select>
                </div>
